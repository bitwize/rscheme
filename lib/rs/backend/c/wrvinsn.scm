...
(define (write-literal-c name c-name part-name unit-name c-args c-monotones)
  (newline)
...
(define (write-vinsns name vinsns c-name part-name unit-name)
  (newline)
...
(define (display-some-monotones name c-name unit-name
				monotones splat-proc part-name)
